...
if (!window.karateDashboardData) {
    ...
    // Default to 'admin' view to show the Admin Dashboard as requested.
    const view = urlParams.get('view') === 'user' ? 'user' : 'admin';
    
    // Always logged in for development preview - Bypassing registration
